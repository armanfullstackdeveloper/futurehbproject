    ...
    */
    function addPrevNext(scope, pageCount, mode) {
        ...
        if (mode === 'prev') {
            ...
            alpha = { value: "<<", title: 'صفحه اول', page: 1 };
            beta = { value: "قبلی", title: 'صفحه قبلی', page: prevPage };
            ...
            alpha = { value: "بعدی", title: 'صفحه بعدی', page: nextPage };
            beta = { value: ">>", title: 'صفحه آخر', page: pageCount };
        }
    ...
    */
    function build(scope, attrs) {
        ...
        if (pageCount <= (fullAdjacentSize + 2)) {
            ...
            else if (scope.page < pageCount - (scope.adjacent)) {
