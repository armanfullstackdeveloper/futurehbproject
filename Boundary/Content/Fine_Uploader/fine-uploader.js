...
(function() {
    ...
    qq.FineUploaderBasic = function(o) {
        ...
        this._options = {
            ...
            messages: {typeError: "  فایل شما باید یک تصویر با یکی از فرمت های  {extensions} باشد  ",sizeError: "فایل انتخابی شما دارای حجم بالایی می باشد ، حداکثر سایز ،{sizeLimit} می باشد ",minSizeError: "{file} is too small, minimum file size is {minSizeLimit}.",emptyError: "لطفا یک تصویر را انتخاب و سپس ارسال را بزنید",noFilesError: "لطفا یک تصویر را انتخاب و سپس ارسال را بزنید",tooManyItemsError: "حداکثر تعداد تصویر {itemLimit} عدد می باشد ",maxHeightImageError: "Image is too tall.",maxWidthImageError: "Image is too wide.",minHeightImageError: "Image is not tall enough.",minWidthImageError: "Image is not wide enough.",retryFailTooManyItems: "Retry failed - you have reached your file limit.",onLeave: "The files are being uploaded, if you leave now the upload will be canceled.",unsupportedBrowserIos8Safari: "Unrecoverable error - this browser does not permit file uploading of any kind due to serious bugs in iOS8 Safari.  Please use iOS8 Chrome until Apple fixes these issues."
            },
